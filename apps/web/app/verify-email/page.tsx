        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition"
            >
            ...
            <Link
              href="/login"
              className="block w-full py-3 px-4 bg-white/10 hover:bg-white/20 text-white rounded-lg font-medium text-center transition"
            >
              Back to Login
            </Link>
          </div>
